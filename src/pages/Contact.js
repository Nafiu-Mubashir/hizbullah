        ...
        <div>
          <div className='flex flex-col lg:flex-row justify-between gap-3 p-3'>
            ...
            <div className='lg:w-[40%] w-full rounded-lg lg:h-[500px] 395.54px p-3'>
              <Header type={1} text={'Send us a message'} className={'text-[20px] lg:text-[32px] mb-4'} />
              <form className="w-full max-w-lg">
                <div className="flex flex-wrap -mx-3 mb-6">
                  <div className="w-full md:w-1/2 px-3 mb-3 lg: md:mb-0">
                    <label className="block uppercase tracking-wide text-black text-xs font-bold mb-2 text-[10.481px] lg:text-[14.8993px]" for="grid-first-name">
                      First Name
                    </label>
                    <input className="appearance-none block w-full bg-white shadow text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none" id="grid-first-name" type="text" placeholder="Jane" />
                  </div>
                  <div className="w-full md:w-1/2 px-3">
                    <label className="block uppercase tracking-wide text-black text-xs font-bold mb-2 text-[10.481px] lg:text-[14.8993px]" for="grid-password">
                      Email
                    </label>
                    <input className="appearance-none block w-full bg-white shadow text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none" id="grid-password" type="mail" placeholder="email@gmail.com" />
                  </div>
                </div>
                <div className="flex flex-wrap -mx-3 mb-3 lg:mb-6">
                  <div className="w-full px-3">
                    ...
                    <textarea className="appearance-none block w-full bg-white shadow h-[200px] text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none" id="grid-password" type="mail" placeholder="Please type your message here..." />
                  </div>
                </div>
          ...
          <div className='flex flex-col lg:flex-row justify-between gap-3 p-3'>
            ...
            <div className='lg:w-[40%] w-full rounded-lg lg:h-[500px] 395.54px p-3'>
              <Header type={1} text={'You can get in touch with us via the following'} className={'text-[20px] lg:text-[32px] mb-4'} />
              <ul class="text-black">

                <li class="mb-4">
                  <a href="/contact" className="hover:underline w-full lg:w-[266px] flex gap-2 justify-center lg:justify-start">
                ...
                <li class="mb-4">
                  <a href="tel:08039187401" className="hover:underline flex gap-2 ">
                    <svg className='' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="mb-4">
                  <a href="mailto:hizbullah@gmail.com?subject" className="hover:underline flex gap-2 ">
            ...
            <div className='p-3 w-full lg:w-[55%]'>
              <div className='w-full'>
                <iframe className='w-full h-[268px] lg:h-[517px]' title='map' frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Al-Kawthar%20Avenue%20Adiyan%20Gasline%20Ogun%20%20state+(Hizbullah%20Movement%20of%20Nigeria)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.maps.ie/distance-area-calculator.html">measure acres/hectares on map</a></iframe>
              </div>
            </div>
          </div>
