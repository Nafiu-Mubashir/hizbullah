                ...
                <div class="flex justify-evenly flex-col lg:flex-row px-5 md:px-3 lg:px-6 py-5 md:py-4 lg:py-8">
                    ...
                    <div className=' text-left mb-4 md:mb-4 lg:mb-0'>
                        ...
                        <ul class="text-[#FFFFFF]">
                            ...
                            <li class="mb-4 text-left">
                                <a href="mailto:info@alkawharfoundations.org?subject" className="hover:underline flex gap-2 justify-start">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className=' text-left'>
                        ...
                        <p class="text-[#FFFFFF] lg:w-[287px] mb-3">
                            Subscribe to get important information when they drop
                        </p>
                        <div>
                            <div class="">
